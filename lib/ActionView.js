...
var ReactBackboneMixin = require('react-backbone-mixin');
...
module.exports = React.createClass({
  ...
  onChange: function(attr) {
    return function () {
      ...
      this.props.model.set(attr, event.target.value);

      // update errors with any new error
      var errors = this.state.errors;
      var newError = this.props.model.preValidate(attr, event.target.value);
